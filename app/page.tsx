  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-blue-100 pb-10">
      ...
      <div className="relative h-[500px] md:h-[600px] flex items-center justify-center mt-16 overflow-hidden">
        ...
        {/* Content */}
        <div className="relative z-10 text-center px-7 max-w-10xl mx-auto mt-10">
            <span className="inline-block py-4 px-20 rounded-full bg-blue-500/20 text-blue-200 border border-blue-400/30 text-sm font-bold mb-8 backdrop-blur-sm">
